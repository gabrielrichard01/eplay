    ...
    <div className="container">
      {isSuccess && data ? (
        <Card title="Muito obrigado">
          <>
            <p>
              É com satisfação que Informamos seu pedido com sucesso! <br />
              ...
              <div className="margin-top">
                {payWithCard ? (
                  ...
                  <p>
                    ...
                    prazos estabelicidos pelas instituições financeiras.
                    Portanto, a liberação do código de ativação do jogo
                    adquirido ocorrerá após a pagamento do boleto.
                  </p>
                )}
              </div>
            </>
